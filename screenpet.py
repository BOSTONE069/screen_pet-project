...
def toggle_eyes(): #This is a function for blinking the eyes
...
mouth_normal = c.create_line(170,250,200,272,230,250,smooth=1 , state=NORMAL)

mouth_happy = c.create_line(170,250, 200, 282, 230,250, smooth=1, state=HIDDEN)

mouth_sad = c.create_line(170,250, 200, 232, 230, 250, smooth=1, state=HIDDEN)
